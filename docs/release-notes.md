...
- Note on 1.7.2: that tag was pushed but never published, because its release build failed while loading the SignPath GitHub policy. 1.7.3 is the first release of this work.
